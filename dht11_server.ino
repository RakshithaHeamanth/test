...
unsigned long myChannelNumber1 = 981874;
const char * myWriteAPIKey1 = "XBFU84YM6YCR9Z7S";
unsigned long myChannelNumber2 = 999110;
const char * myWriteAPIKey2 = "H5BYYFKBF3QFSOLI";
unsigned long myChannelNumber3 = 999111;
const char * myWriteAPIKey3 = "XV1LT3235J8XZ0HI";
unsigned long myChannelNumber4 = 999112;
const char * myWriteAPIKey4 = "GTHHFHKWYR21IJTC";
uint16_t crcdata = 0;
        ...
        if (rf95.recv(buf, &len))//Check if there is incoming data
        {
            ...
            { 
                ...
                if(buf[0] == 1||buf[1] == 1||buf[2] ==1) //Check if the ID match the LoRa Node ID
                {
                    ...
                    ThingSpeak.setField(3,analogRead(A1));
                     ThingSpeak.setField(4,digitalRead(2));
                     ThingSpeak.setField(5,digitalRead(6));
                    ThingSpeak.writeFields(myChannelNumber1, myWriteAPIKey1);   // Send Data to IoT Server.
                 ThingSpeak.setField(2,h); // 
                    ThingSpeak.setField(1,t);
                    ThingSpeak.setField(3,analogRead(A1));
                     ThingSpeak.setField(4,digitalRead(2));
                ...
                ThingSpeak.setField(2,h); // 
                    ...
                    ThingSpeak.setField(3,analogRead(A1));
                     ThingSpeak.setField(4,digitalRead(2));
                     ThingSpeak.setField(5,digitalRead(6));
                    ThingSpeak.writeFields(myChannelNumber3, myWriteAPIKey3);   // Send Data to IoT Server.
                 ThingSpeak.setField(2,h); // 
                    ThingSpeak.setField(1,t);
                    ThingSpeak.setField(3,analogRead(A1));
                     ThingSpeak.setField(4,digitalRead(2));
